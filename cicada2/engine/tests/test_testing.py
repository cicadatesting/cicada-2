...
def test_continue_running_no_asserts_no_remaining():
    assert not testing.continue_running(asserts=[], remaining_cycles=0, assert_statuses={})
...
def test_continue_running_asserts_unlimited_first_run():
    ...
    assert testing.continue_running(asserts=test_asserts, remaining_cycles=-1, assert_statuses={})
