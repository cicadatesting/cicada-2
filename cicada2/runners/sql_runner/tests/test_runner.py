...
def test_contains_rows():
    expected_rows = [{"foo": "bar", "fizz": "buzz"}, {"foo": "alpha", "fizz": "bravo"}]

    actual_rows = [{"foo": "bar", "fizz": "buzz"}, {"foo": "alpha", "fizz": "bravo"}]
...
def test_contains_rows_subset_1():
    expected_rows = [{"foo": "bar"}, {"foo": "alpha"}]
...
def test_contains_rows_fail_2():
    expected_rows = [{"foo": "bar"}, {"foo": "alpha"}, {"foo": 1}]
...
def test_equals_rows_different_length_1():
    expected_rows = [{"foo": "bar", "fizz": "buzz"}]
...
def test_equals_rows_failed():
    expected_rows = [{"foo": "alpha", "fizz": "bravo"}]
    ...
    assert (
        description
        == "Expected {'foo': 'alpha', 'fizz': 'bravo'}, got {'foo': 'bar', 'fizz': 'buzz'}"
    )
